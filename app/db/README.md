...
1. `StateDB` 当前 schema 版本为 `4`。
2. 核心表包括 `tasks`、`task_logs`、`task_results`、`task_stock_states`、`maintenance_jobs`、`maintenance_logs`、`maintenance_retry_tasks`、`concept_jobs`、`concept_logs`、`_maintenance_meta`、`app_meta`。
